...
import {faBoxOpen,faUserAlt,faSignInAlt} from "@fortawesome/free-solid-svg-icons";
      ...
      <Aux>
        ...
        <div className="bottom-navigation">
            {localStorage.getItem('signIn') ?
               ...
               <Aux>
                   <NavLink className="names"  exact  to='/' onClick={this.activeIcon} >
                   ...
                   <NavLink  className="names" to='/cart' onClick={this.activeIcon} >
                       <div className="flex-item" style={{width: "22%"}}>
                           <i
                   ...
                   <NavLink className="names" to='/orders' onClick={this.activeIcon}>
                       <div className="flex-item" style={{width: "22%"}}>
                   ...
                   <NavLink className="names" to='/profile' onClick={this.activeIcon}>
                       <div className="flex-item" style={{width: "22%"}}>
                           <FontAwesomeIcon icon={faUserAlt}
                                            style={{ fontSize: "20px",margin:0,padding:0}}
                           /><br/>
                           <span style={{fontSize : "10px",margin:0,padding:0}}>PROFILE</span>
                       </div>
                   </NavLink >
               </Aux> :
                <Aux>
